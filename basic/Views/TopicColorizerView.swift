...
struct TopicColorizerView: View {
  ...
  @Binding var selectedSchemeIndex: Int//ColorSchemeName // Binding to reflect changes back to TopicsChooserScreen
...
struct TopicDropDelegate: DropDelegate {
  let topic: (id: UUID, name: String, schemeIndex: Int)//ColorSchemeName)
  @Binding var topics: [String]
  let fromIndex: Int
